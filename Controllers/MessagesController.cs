...
namespace Online_Discussions_Web_API.Controllers
{
    ...
    {
        private readonly Online_Discussions_Web_APIDataContext _context;

        public MessagesController(Online_Discussions_Web_APIDataContext context)
        {
            _context = context;
        }
